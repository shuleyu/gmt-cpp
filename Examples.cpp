...
//     GMT::psxy(outfile,data,"-JX"+to_string(Len)+"i -R-10/10/-10/10 -Sc0.15i -W1p,black -N -O -K");
    ...
    GMT::psxy(outfile,data1,"-JX"+to_string(Len)+"i -R-10/10/-10/10 -Sc -Ctmp.cpt -Bxa5g1 -Bya10g1 -BWSne -W1p,black -N -O -K");
    remove("tmp.cpt");
...
//     GMT::psxy(outfile,data,"-JX"+to_string(Len)+"i -R-10/10/-10/10 -Sc0.15i -W1p,black -N -O -K");
    ...
    GMT::psxyz(outfile, data2,"-JX"+to_string(Len)+"i -JZ" + to_string(Len) + "i -R0/10/0/10/0/10 -Su2u -W1p,black -Ctmp.cpt -Bx2+lXLABEL -By2+lYLABEL -Bz10+lZLABEL -BWSneZ1 -t50 -p135/30 -N -O -K");
    remove("tmp.cpt");
